...
// ==========================================
// 2. HÀM PHÁT VIDEO MUTED AN TOÀN TUYỆT ĐỐI
// ==========================================
function playMutedVideo(videoEl, onEndedCallback) {
    ...
    videoEl.muted = true; // Tắt tiếng 100% để trình duyệt không bao giờ chặn
